package com.chuangxin.monitor.utils;
 ...
 */
public class Modbus4jReadTcpUtils {
    /**
     * 工厂。
     */
    ...
    public static ModbusMaster getMaster() throws ModbusInitException {
        ...
        //ModbusMaster master = modbusFactory.createRtuMaster(); //RTU 协议
    ...
    /**
     * 读取[01 Coil Status 0x]类型 开关数据    读线圈
     *
    ...
    /**
     * 读取[02 Input Status 1x]类型 开关数据   读离散量输入
     *
     * @param slaveId
     * @param offset
     * @return
    ...
    /**
     * 读取[03 Holding Register类型 2x]模拟量数据   读保持寄存器：指定数据类型
     *
    ...
    /**
     * 读取[04 Input Registers 3x]类型 模拟量数据  读输入寄存器：指定数据类型
     *
     * @param slaveId  slaveId
     * @param offset   位置
     * @param dataType 数据类型,来自com.serotonin.modbus4j.code.DataType
