 ...
 *
 */
public class Modbus4jWriteTcpUtils {
    static Log log = LogFactory.getLog(Modbus4jWriteTcpUtils.class);
    ...
    public static ModbusMaster getMaster() throws ModbusInitException {
        ...
        params.setPort(PORT);
        log.info("ip:"+params.getHost()+"<============>port:"+PORT);
    ...
    public static boolean writeRegister(int slaveId, int writeOffset, short writeValue)
        ...
        log.info("slaveId:"+slaveId+"<=========>writeOffset:"+writeOffset+"<=========>writeValue"+writeValue);
